...
from .views import (
    ...
    ImportTravelView, DownloadTravelTemplateView
)
...
urlpatterns = [
    ...
    # Import URLs
    path('viagens/importar/', ImportTravelView.as_view(), name='viagem_import'),
    path('viagens/modelo/', DownloadTravelTemplateView.as_view(), name='viagem_download_template'),
]
